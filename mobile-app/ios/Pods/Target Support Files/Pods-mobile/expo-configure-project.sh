...
with_node \
  ...
  --target "/Users/pavlogr/Desktop/vango/mobile-app/ios/Pods/Target Support Files/Pods-mobile/ExpoModulesProvider.swift" \
  --entitlement "/Users/pavlogr/Desktop/vango/mobile-app/ios/mobile/mobile.entitlements" \
  --platform "apple" \
  --packages "expo" "expo-application" "expo-asset" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-image-picker" "expo-keep-awake" "expo-location" "expo-notifications"
