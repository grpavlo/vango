...
function mapSmsErrorToMessage(error) {
  ...
  if (text.includes('INSUFFICIENTFUNDS') || text.includes('LOW_BALANCE') || text.includes('NOT_ENOUGH')) {
    return {
      status: 503,
      message: '\u0422\u0438\u043c\u0447\u0430\u0441\u043e\u0432\u043e \u043d\u0435 \u0432\u0434\u0430\u0454\u0442\u044c\u0441\u044f \u043d\u0430\u0434\u0456\u0441\u043b\u0430\u0442\u0438 SMS: \u043d\u0435\u0434\u043e\u0441\u0442\u0430\u0442\u043d\u0456\u0439 \u0431\u0430\u043b\u0430\u043d\u0441 SMS-\u0441\u0435\u0440\u0432\u0456\u0441\u0443.',
    };
  }
  if (text.includes('INVALID PHONE') || text.includes('INVALID RECIPIENT')) {
    return {
      status: 400,
      message: '\u0412\u043a\u0430\u0436\u0456\u0442\u044c \u043a\u043e\u0440\u0435\u043a\u0442\u043d\u0438\u0439 \u043d\u043e\u043c\u0435\u0440 \u0442\u0435\u043b\u0435\u0444\u043e\u043d\u0443.',
    };
  }
  if (text.includes('SMS SERVICE IS NOT CONFIGURED')) {
    return {
      status: 503,
      message: '\u0421\u0435\u0440\u0432\u0456\u0441 SMS \u0442\u0438\u043c\u0447\u0430\u0441\u043e\u0432\u043e \u043d\u0435\u0434\u043e\u0441\u0442\u0443\u043f\u043d\u0438\u0439. \u0421\u043f\u0440\u043e\u0431\u0443\u0439\u0442\u0435 \u043f\u0456\u0437\u043d\u0456\u0448\u0435.',
    };
  }
  return {
    status: 500,
