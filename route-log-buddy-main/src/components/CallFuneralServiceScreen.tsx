...
interface CallFuneralServiceScreenProps {
  onBack: () => void;
}

const CallFuneralServiceScreen = ({ onBack }: CallFuneralServiceScreenProps) => {
        ...
        {!isCalling ? (
          <div className="flex flex-col items-center justify-center space-y-6 mt-16">
            <div className="text-center space-y-2">
              <p className="text-lg text-muted-foreground">Emergency assistance</p>
              <p className="text-xl font-mono text-foreground">911</p>
            </div>
          ...
          <div className="flex flex-col items-center justify-center space-y-8 mt-16">
            <div className="text-center space-y-4">
              ...
              <h2 className="text-2xl font-semibold text-foreground">Dialing 911...</h2>
              <p className="text-muted-foreground">If this was accidental, hang up.</p>
            </div>
...
export default CallFuneralServiceScreen;