	...
	theme: {
		...
		extend: {
			colors: {
				...
				// Route Logs brand colors
				'dark-navy': 'hsl(var(--dark-navy))',
				'turquoise-primary': 'hsl(var(--turquoise-primary))',
				'accent-blue': 'hsl(var(--accent-blue))',
				'warm-orange': 'hsl(var(--warm-orange))',
				'light-yellow': 'hsl(var(--light-yellow))',
				'route-card-border': 'hsl(var(--route-card-border))',
				'route-card-selected': 'hsl(var(--route-card-selected))',
